...
type CategoryRepoI interface {
	...
	Delete(req *models.CategoryPrimaryKey) (string, error)
}
...
type ProductRepoI interface {
	...
	Delete(req *models.ProductPrimaryKey) (string, error)
}
...
type ClientRepoI interface {
	...
	Delete(req *models.ClientPrimaryKey) (string, error)
}
...
type BranchRepoI interface {
	...
	Delete(req *models.BranchPrimaryKey) (string, error)
}
